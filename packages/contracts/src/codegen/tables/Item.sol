...
library Item {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "nethmudtest", name: "Item", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626e6574686d7564746573740000004974656d000000000000000000000000);
   ...
   * @notice Get value.
   */
  function getValue(uint32 id) internal view returns (uint32 value) {
   ...
   * @notice Get value.
   */
  function _getValue(uint32 id) internal view returns (uint32 value) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));
   ...
   * @notice Get value.
   */
  function get(uint32 id) internal view returns (uint32 value) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));
   ...
   * @notice Get value.
   */
  function _get(uint32 id) internal view returns (uint32 value) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));
   ...
   * @notice Set value.
   */
  function setValue(uint32 id, uint32 value) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));
   ...
   * @notice Set value.
   */
  function _setValue(uint32 id, uint32 value) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));
   ...
   * @notice Set value.
   */
  function set(uint32 id, uint32 value) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));
   ...
   * @notice Set value.
   */
  function _set(uint32 id, uint32 value) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));
